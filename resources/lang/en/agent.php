...
return array (
  ...
  array (
    ...
    'regex' => 'The user name must consist of 6-20 letters, underscore, number, and Chinese',
  ),
  'password' => 
  array (
  ...
  'last_max_next_min' => 'The maximum value of the previous item can not be greater than or equal to the minimum value of the next item',
  ...
  'test_account' => 'Account for the test account, can not log on',
);